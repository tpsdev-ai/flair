 ...
 * Embeddings are auto-generated by the middleware on Memory writes.
 * The embed-server sidecar is only needed for search queries.
 */
...
try {
  ...
  switch (action) {
    ...
    case 'write': {
      ...
      // Use PUT so middleware can extract ID from URL and auto-embed
    ...
    case 'search': {
      ...
      // For search, we still need the sidecar to embed the query
